            ...
            case .success(let user):
                ...
                PersistenceManager.updateWith(favorite: favorite, actionType: .add) { [weak self] error in
                    ...
                    guard let error = error else {
                        self.presentCFAlertOnMainThread(title: "Succes", message: "You have succesfully favorited 🎉.", buttonTitle: "Hooray!")
                        return
                    }
                ...
                break
            case .failure(let error):
                self.presentCFAlertOnMainThread(title:"Something went strong.", message: error.rawValue, buttonTitle: "Ok")
            }
        }
